...
public class EmployeeOperations {
    ...
    public void createContactSequence() {
        try {
            String createsq1 = "create sequence cid_seq increment by 1 start with 1";
         pstmt = conn.prepareStatement(createsq1);
            pstmt.executeUpdate();
    ...
    public void fillTables(){
        ...
        try{
            ...
            String csql1 = "INSERT INTO CONTACT VALUES "
                    + "(cid.nextVal,'Mary','2 Grafton St','087654678','mary@grafton.com',eid_seq.currVal)";
            ...
            String csql2 = "INSERT INTO CONTACT VALUES "
                    + "(cid.nextVal,'Ella','2 Jones St','0865432345','ella@jones.com',eid_seq.currVal)";
            stmt.executeUpdate(csql2);
            ...
            String csql3 = "INSERT INTO CONTACT VALUES "
                    + "(cid.nextVal,'Seamus','12 Henry St','0879876543','seamy@henry.com',eid_seq.currVal)";
            stmt.executeUpdate(csql3);
