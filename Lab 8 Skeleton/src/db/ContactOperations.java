...
public class ContactOperations {
    ...
    public void dropContactsSequence() {
        try {
            ...
            System.out.println("Problem dropping the Contact sequence"+ ex.getMessage());
        }
    }
    ...
    public void createContactsSequence() {
        ...
        try {
            ...
            System.out.println("Problem with Create Sequence " + ex.getMessage());
        }
    ...
    public void CreateContactsTable() {
	    ...
	    // Insert data into table
            ...
            System.out.print("SQL Exception creating and inserting values into Contacts " + e);
            System.exit(1);
        }
    }
    ...
    public ResultSet getContacts() {
        ...
        try {
            ...
            System.out.println("ERROR in getContacts() method " + ex.getMessage());
        }
        return rset;
    }
    
    public ResultSet getMaxContact() {
        String sqlStatement = "SELECT * FROM MyContacts where id in (select max (id) from MyContacts)";

        try {
            pstmt = conn.prepareStatement(sqlStatement);
            rset = pstmt.executeQuery();
        } catch (SQLException ex) {
            System.out.println("ERROR in getMaxContact() method " + ex.getMessage());
        }
        return rset;
    }
